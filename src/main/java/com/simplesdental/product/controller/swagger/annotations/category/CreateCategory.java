                ...
                @ApiResponse(description = "Bad Request", responseCode = "400",
                        content = @Content(
                                ...
                                examples = {
                                        @ExampleObject(
                                                name = "Exemplo 1",
                                                description = "Atributo 'name' não deve ser nulo ou em branco e 'description' não deve maior que 255 caracteres",
                                                value = """
                                                    {
                                        ...
                                        @ExampleObject(
                                                name = "Exemplo 2",
                                                description = "Atributo 'name' não deve ser maior que 100 caracteres",
                                                value = """
                                                    {
                                                        "timestamp": "2025-04-04T18:30:00Z",
                                                        "status": 400,
